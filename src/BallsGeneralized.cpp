    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        */
        ...
        if (unfinished_collision == false && (sqrt(pow((x_positions[0] - x_positions[1]), 2) + pow((y_positions[0] - y_positions[1]), 2)) < 2 * 0.1)) {
            ...
            std::cout << "Waitings so far: " << waitingsSoFar << std::endl;
        ...
        */
        ...
        if ((sqrt(pow((x_positions[0] - x_positions[1]), 2) + pow((y_positions[0] - y_positions[1]), 2)) < 2 * 0.1)) {
            //move the two balls outside of their range
            
            
            float x_midpoint = x_positions[0] + ((x_positions[1] - x_positions[0]) / 2);
            float y_midpoint = y_positions[0] + ((y_positions[1] - y_positions[1]) / 2);
            std::cout << "midpoint: <" << x_midpoint << ", " << y_midpoint << ">" << std::endl;
            
            
            //main = 0;
            float mid_x_0 = x_positions[0] - x_midpoint;
            float mid_y_0 = y_positions[0] - y_midpoint;
            std::cout << "Dist to midpoint: <" << mid_x_0 << ", " << mid_y_0 << ">" << std::endl;
            float mid_mag_0 = sqrt(pow((mid_x_0), 2) + pow((mid_y_0), 2));
            float scalar_0 = 0.11 / mid_mag_0;
            float dist_to_travel_x_0 = scalar_0 * mid_x_0;
            float dist_to_travel_y_0 = scalar_0 * mid_y_0;
            std::cout << "Dist to travel: <" << dist_to_travel_x_0 << ", " << dist_to_travel_y_0 << ">" << std::endl;
            //x_positions[0] = x_positions[0] + dist_to_travel_x_0;
            //y_positions[0] = y_positions[0] + dist_to_travel_y_0;

            /*
            //main = 1;
            float mid_x_1 = x_midpoint - x_positions[1];
            float mid_y_1 = y_midpoint - y_positions[1];
            float mid_mag_1 = sqrt(pow((mid_x_1), 1) + pow((mid_y_1), 2));
            float scalar_1 = 0.11 / mid_mag_1;
            float dist_to_travel_x_1 = scalar_1 * mid_x_1;
            float dist_to_travel_y_1 = scalar_1 * mid_y_1;
            x_positions[1] = x_positions[1] + dist_to_travel_x_1;
            y_positions[1] = y_positions[1] + dist_to_travel_y_1;
            */
